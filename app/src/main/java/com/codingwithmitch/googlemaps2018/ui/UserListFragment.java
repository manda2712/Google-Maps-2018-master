...
public class UserListFragment extends Fragment implements
        ...
        UserRecyclerAdapter.UserListRecycleClickListener {
    ...
    private void initGoogleMap(Bundle savedInstanceState){
        ...
        if (mGeoApiContext == null){
            mGeoApiContext = new GeoApiContext.Builder().apiKey(getString(R.string.google_map_api_key))
                    .build();
        }
    }
...
//        setCameraView();
        ...
        for(PolylineData polylineData: mPolylinesData){
            ...
            if(polyline.getId().equals(polylineData.getPolyline().getId())){
                ...
                Marker marker = mGoogleMap.addMarker(new MarkerOptions()
                        ...
                        .title("Trip: " + index)
                        .snippet("Suration: " + polylineData.getLeg().duration)
                );
    ...
    public void onUserClicked(int position) {
        Log.d(TAG, "onUserClicked: selected user: " + mUserList.get(position).getUser_id());
